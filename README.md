...
> proyecto `pbkbqggeaquncsmuykec`), **no ejecutes el archivo 004**: esas
> tablas y esa función ya están aplicadas ahí. Este archivo solo hace
> falta si estás configurando el proyecto desde cero en un Supabase
> distinto.
